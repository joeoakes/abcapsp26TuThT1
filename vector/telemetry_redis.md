...
Common Shell Mistake (and Fix)
If you type a placeholder like this:
redis-cli HGETALL <paste_one_telemetry_key_here>
you will get a shell error because <...> is not a real key.
